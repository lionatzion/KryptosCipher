...
def derive_constraints_from_islands(cipher: str, islands: List[Tuple[int, str]], period: int) -> Dict[int, str]:
...
def enforce_A_positions(constraints: Dict[int, str], enforce_positions_1b: List[int], period: int) -> Dict[int, str]:
